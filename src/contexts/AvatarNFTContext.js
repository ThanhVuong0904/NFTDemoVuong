...
export const AvatartNFTContext = createContext()

const AvatartNFTContextProvider = ({children}) => { 
     //Eye, Headdress...
     ...
     return (
          <AvatartNFTContext.Provider value={state}>
               {children}
          </AvatartNFTContext.Provider>
     )
}

export default AvatartNFTContextProvider